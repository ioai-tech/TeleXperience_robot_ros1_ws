...
tmux send-keys -t io_teleop_v3_ros1_ws "source /opt/ros/noetic/setup.bash; source devel/setup.bash; python3 src/io_teleop_robot_control_node/scripts/openloong_controller_node.py " C-m
